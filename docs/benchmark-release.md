...
- **12 intrusions**, each a separate ECS-shaped NDJSON file.
- **56,613 records**, of which **88 are malicious**, a **0.16% malicious
  ratio**, realistically skewed, not a balanced toy set.
- **41 distinct ATT&CK techniques** across the set (through the Impact tactic), spanning endpoint, identity, network, DNS, web/proxy, file, mail, and cloud control-plane telemetry.
